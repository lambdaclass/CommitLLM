...
use vi_core::streaming::StreamingKvVerifier;
use vi_core::types::{AuditChallenge, AuditTier};
use vi_test_vectors::{
...
use vi_verify::{build_audit_challenge, derive_audit_layers, verify_audit, Verdict};

fn setup() -> (
    ModelConfig,
    Vec<vi_test_vectors::LayerWeights>,
