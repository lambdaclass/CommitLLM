...
//! production verification, see `vi-vllm::w8a8_verify`.
//!
//! # Verification levels
//!
...
use vi_core::constants::MatrixType;
use vi_core::margin;
...
pub fn verify_sampling(
    key: &VerifierKey,
    trace: &TokenTrace,
    params: &vi_core::sampling::DecodeParams,
    batch_seed: &[u8; 32],
) -> Vec<String> {
    let mut failures = Vec::new();
    ...
    let replayed = vi_core::sampling::replay_sampling(
        lm_head,
        final_hidden,
...
pub fn verify_manifest(
    commitment: &vi_core::types::BatchCommitment,
...
pub fn verify_batch_with_policy(
    ...
    if proof.commitment.version == vi_core::types::CommitmentVersion::V2
        || proof.commitment.version == vi_core::types::CommitmentVersion::V3
    {
    ...
    if proof.commitment.version == vi_core::types::CommitmentVersion::V3 {
    ...
    for trace in &proof.traces {
        ...
        let io = if proof.commitment.version == vi_core::types::CommitmentVersion::V3 {
