...
fn test_batch_serialization_roundtrip() {
    ...
    let data = vi_core::serialize::serialize_batch(&proof);
    let proof2 = vi_core::serialize::deserialize_batch(&data).unwrap();
...
fn test_compact_reconstructs_derivable_fields() {
    use vi_core::types::CompactLayerTrace;
...
fn test_empty_batch_proof() {
    use vi_core::types::{BatchProof, BatchCommitment};
...
fn test_single_field_mutation_always_detected() {
    ...
    let field_mutators: Vec<(&str, Box<dyn Fn(&mut vi_core::types::LayerTrace)>)> = vec![
        ("x_attn", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.x_attn[0] = lt.x_attn[0].wrapping_add(1))),
        ("q", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.q[0] = lt.q[0].wrapping_add(1))),
        ("k", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.k[0] = lt.k[0].wrapping_add(1))),
        ("v", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.v[0] = lt.v[0].wrapping_add(1))),
        ("a", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.a[0] = lt.a[0].wrapping_add(1))),
        ("attn_out", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.attn_out[0] = lt.attn_out[0].wrapping_add(1))),
        ("x_ffn", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.x_ffn[0] = lt.x_ffn[0].wrapping_add(1))),
        ("g", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.g[0] = lt.g[0].wrapping_add(1))),
        ("u", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.u[0] = lt.u[0].wrapping_add(1))),
        ("h", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.h[0] = lt.h[0].wrapping_add(1))),
        ("ffn_out", Box::new(|lt: &mut vi_core::types::LayerTrace| lt.ffn_out[0] = lt.ffn_out[0].wrapping_add(1))),
    ];
...
fn test_compact_trace_corrupted_g_field() {
    use vi_core::types::CompactBatchProof;
