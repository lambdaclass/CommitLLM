...
fn test_v2_commit_sets_version_v2() {
    ...
    assert_eq!(
        commitment.version,
        verilm_core::types::CommitmentVersion::V2,
...
fn test_legacy_commit_sets_version_v1() {
    ...
    assert_eq!(
        commitment.version,
        verilm_core::types::CommitmentVersion::V1,
...
fn test_full_batch_e2e_serialized_with_token_ids() {
    ...
    assert_eq!(commitment.version, verilm_core::types::CommitmentVersion::V2);
    ...
    assert_eq!(proof_rt.commitment.version, verilm_core::types::CommitmentVersion::V2,
...
fn test_serialized_token_swap_detected() {
    use verilm_core::serialize::{serialize_batch, deserialize_batch};
