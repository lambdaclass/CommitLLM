...
| 2d | **Better `a` quantization** — per-head scales instead of per-tensor, INT16/FP16 retained `a` instead of INT8. Most promising path to reduce τ below adversarial threshold. | open |
