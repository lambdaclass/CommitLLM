...
11. **Align verifier/docs/reporting to the kept stock-mode attention claim** — remove `StockBounded`, `verified-attention`, and any “verified attention” product language from the verifier, README, roadmap, and CHANGELOG. State exactly: decode is exact; attention inputs/wiring are audited; arbitrary-position attention outputs are not verified. Paper revision is split out as item 11a.
