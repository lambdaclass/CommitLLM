...
16. **Reduce commit/finalize overhead** — this is now the main online cost bottleneck after decode exactness and the audit-only stock attention path landed.
17. **Close the remaining trust/paper/docs language** — finish the paper revision, make the last-generated-token score-witness scope explicit, and lock the guarantee wording around audited attention inputs/wiring only.
...
12. Reduce commit/finalize overhead and finish the remaining honest product docs/paper.
13. Cut the release.
