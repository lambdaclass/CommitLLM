...
1. settle the attention replay inputs in protocol form: quantization semantics (#77), bridge trust boundary (#78), committed full-causal KV transcript (#72)
2. measure the attention corridor with structurally complete replay (#28), then set evidence-based tau
3. bind the committed KV transcript back to real computation with provenance checks (#76)
...
6. clean the public product/docs surface for the first release — including audit tier separation (#79) and guarantee language (#80)
